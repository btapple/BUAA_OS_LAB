...
//
// +--------10-------+-----10------+--------12-----------+
// |  Page Directory |  Page Table |  Offset whthin page |
// |       Index	 |     Index   |                     |
// +-----------------+------10-----+---------------------+
// \-----PDX(va)----/ \--PTX(va)--/
...
#define PDX(va) ((((u_long)(va)) >> 22) & 0x03FF) // get page directory index and set high bits 0
#define PTX(va) ((((u_long)(va)) >> 12) & 0x03FF) // get page table directory index and set high bits 0
